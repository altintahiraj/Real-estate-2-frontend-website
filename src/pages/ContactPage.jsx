                ...
                <div className="contact-left-panel">
                    <div className="contact-left-content">
                        ...
                        <p className="contact-intro">
                            Whether you're buying, selling, or simply exploring, our team is here 
                            to provide expert guidance tailored to your unique vision.
                        </p>
                        ...
                        <div className="contact-methods">
                            <div className="contact-method">
                                ...
                                <div className="contact-method-details">
                                    ...
                                    <div className="contact-method-value">info@apexestates.com</div>
                                    <div className="contact-method-note">Response within 2 hours</div>
                                </div>
                            </div>
                            ...
                            <div className="contact-method">
                                ...
                                <div className="contact-method-details">
                                    ...
                                    <div className="contact-method-value">(310) 555-APEX</div>
                                    <div className="contact-method-note">Mon-Fri, 9 AM - 6 PM PST</div>
                                </div>
                            </div>
                            ...
                            <div className="contact-method">
                                ...
                                <div className="contact-method-details">
                                    ...
                                    <div className="contact-method-value">123 Luxury Lane</div>
                                    <div className="contact-method-note">Beverly Hills, CA 90210</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="contact-form-wrapper">
                        ...
                        <form onSubmit={handleSubmit} className="contact-form-luxury">
                            ...
                            <div className={`form-field ${focusedField === 'propertyType' ? 'focused' : ''} ${formData.propertyType ? 'filled' : ''}`}>
                                <label className="form-field-label">I'm interested in</label>
                                <select
                                    name="propertyType"
                                    className="form-field-input"
